Module Funciones_y_Variables_publicas
    ...
    Public fecha2 As String = Now.Date.ToString("yyyy-MM-dd")
    ...
    Public Sub conn()
        Try
            Dim connectionString As String = "FILEDSN=" & Application.StartupPath & "\conexion.dsn;"
            ...
            ' Si la conexión se abre correctamente, muestra un mensaje de éxito.

        Catch ex As Exception
            ' Si ocurre algún error durante la conexión, muestra el mensaje de error.
            MsgBox("ERROR: " & ex.Message, MsgBoxStyle.Critical, "Error en la conexión2")
