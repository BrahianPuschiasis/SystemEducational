...
"<div id='apDiv1'>" & _
        ...
        While horariofinalizoescrito.Read
            Dim inicioe As TimeSpan = horariofinalizoescrito("inicioe")
            Dim fine As TimeSpan = horariofinalizoescrito("fine")
            rep = rep & "<td bgcolor='#FFFFFF'>" & dia & "</td>" &
                "<td bgcolor='#FFFFFF'>" & mes & "</td>" &
                 "<td bgcolor='#FFFFFF'>" & años & "</td>" &
                 "<td bgcolor='#FFFFFF'>" & inicioe.ToString() & "</td>" &
                 "<td bgcolor='#FFFFFF'>" & fine.ToString() & "</td>" &
                "</tr>"
        End While
        ...
        While oralhorariofin.Read
            Dim inicioo As TimeSpan = CType(oralhorariofin("inicioo"), TimeSpan)
            Dim fino As TimeSpan = CType(oralhorariofin("fino"), TimeSpan)
            rep = rep & "<td bgcolor='#FFFFFF'>" & dia & "</td>" &
                  "<td bgcolor='#FFFFFF'>" & mes & "</td>" &
                  "<td bgcolor='#FFFFFF'>" & años & "</td>" &
                  "<td bgcolor='#FFFFFF'>" & inicioo.ToString() & "</td>" &
                  "<td bgcolor='#FFFFFF'>" & fino.ToString() & "</td>" &
                  "</tr>"
        End While
