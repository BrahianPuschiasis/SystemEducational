Public Class Altatcurso
    ...
    Private Sub btnconfirmar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnconfirmar.Click
        ...
        If txtidcurso.Text <> "" Then
            If txtnobcurso.Text <> "" Then
                If txtAbreviacion.Text <> "" Then

                    Try
                        sql = "INSERT INTO t_curso(idcurso,t_curso,completo)"
                        sql += "VALUES(" & txtidcurso.Text & ",'" & txtnobcurso.Text & "', '" & txtAbreviacion.Text & "')"

                        Cmd.CommandText = sql
                        Cmd.ExecuteNonQuery()
                        MsgBox("Los Datos han sido ingresados", MsgBoxStyle.Information, "Aviso")
                        sql = "INSERT INTO historia (ciautor,pk,accion,descripcion,tabla,fecha,hora) VALUES ( " & login2 & ",'" & txtidcurso.Text & "','Insertar','Se creó el tipo de curso','t_curso', '" & fecha2 & "', '" & lblhora2.Text & "')"

                        Cmd.CommandText = sql

                        Cmd.ExecuteNonQuery()
                    Catch
                        MsgBox("ERROR 31:Ya existe el curso")

                    End Try
                Else
                    MsgBox("ERROR 32:No puede dejar la Abreviación en blanco")
                End If
            Else
                MsgBox("ERROR 12:No puede dejar el Nombre en blanco")
            End If
        Else
            MsgBox("ERROR 13:No puede dejar el Código en blanco")
        End If
    ...
    Private Sub Altatcurso_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub txtnobcurso_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtnobcurso.KeyPress
    ...
    Private Sub txtnobcurso_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtnobcurso.TextChanged

    End Sub

    Private Sub txtidcurso_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtidcurso.KeyPress
    ...
    Private Sub txtidcurso_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtidcurso.TextChanged
