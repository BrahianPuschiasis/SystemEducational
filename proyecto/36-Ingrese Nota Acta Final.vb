Public Class IngreseNotaActaFinal
    ...
    Private Sub IngreseNotaActaFinal_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        conn()
        cedulas = cilogin
        sql13 = "SELECT grupo.idgrupo,grado,orientacion.orientacion,grupo.nombre from grupo,dictan,orientacion,instituto, actaf where dictan.ci = " & cedulas & " and orientacion.idori = grupo.orientacion and grupo.idgrupo = dictan.idgrupo and dictan.anio = grupo.anio and actaf.idgrupo = grupo.idgrupo and actaf.estado='Abierta'and grupo.anio = " & Now.Year & "  group by grupo.idgrupo,grupo.grado,grupo.nombre,orientacion.orientacion  order by grupo.idgrupo "
