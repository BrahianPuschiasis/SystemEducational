...
Public Class AltaDocente
    ...
    Private Sub btnconfirmar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnconfirmar.Click
        ...
        If cmbCargo.Text = "Docente" Then
            ...
            Else
                ...
                sql7 = "INSERT INTO dictan(ci,idgrupo,anio,idasig,activo) "
        ...
        If cmbCargo.Text = "Alumno" Then
            Dim idgrupo As Integer
            sql8 = "SELECT idgrupo from dictan where ci= " & txtci.Text & " and anio = " & Now.Year & " and activo='Activo'"
            Cmd.CommandText = sql8
            Cmd.ExecuteScalar()
            idgrupo = Cmd.ExecuteScalar
    ...
    Private Sub cmbCargo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbCargo.SelectedIndexChanged
        ...
        If cmbCargo.Text = "Docente" Then
            ...
            sql2 = "SELECT dictan.ci,dictan.idgrupo,dictan.anio,dictan.idasig,asignatura.nombre,grupo.grado,orientacion.orientacion,grupo.nombre,dictan.activo from grupo,asignatura,dictan,orientacion where dictan.ci= " & txtci.Text & " and dictan.idgrupo = grupo.idgrupo and dictan.idasig = asignatura.idasig and orientacion.idori = grupo.orientacion and dictan.anio = " & Now.Year & " group by dictan.ci,dictan.idgrupo,dictan.anio,dictan.idasig,asignatura.nombre,grupo.grado,orientacion.orientacion,grupo.nombre,dictan.activo"
            Cmd.CommandText = sql2
    ...
    Private Sub btnAsignatura_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAsignatura.Click
        ...
        Catch
            ...
            sql = "SELECT dictan.ci,dictan.idgrupo,dictan.anio,dictan.idasig,asignatura.nombre,grupo.grado,orientacion.orientacion,grupo.nombre,dictan.activo from grupo,asignatura,dictan,orientacion where dictan.ci= " & txtci.Text & " and dictan.idgrupo = grupo.idgrupo and dictan.idasig = asignatura.idasig and orientacion.idori = grupo.orientacion and dictan.anio = " & Now.Year & " group by dictan.ci,dictan.idgrupo,dictan.anio,dictan.idasig,asignatura.nombre,grupo.grado,orientacion.orientacion,grupo.nombre,dictan.activo"
            Cmd.CommandText = sql
            Dim dw As New Odbc.OdbcDataAdapter(sql, conect)
            dw.Fill(Ds, "dictan")
        End Try
    ...
    Private Sub DGADocente_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DGADocente.CellContentClick
        ...
        Dim activos As String
        Dim resp As String
        sql2 = "SELECT activo from dictan where ci= " & ci & " and idgrupo= " & idgrupo & " and idasig= " & idasig & " and anio = " & Now.Year & ""
        Cmd.CommandText = sql2
        activos = Cmd.ExecuteScalar
        ...
        If resp = vbYes Then
            If activos = "Activo" Then
                sql = "UPDATE dictan set activo='No Activo' where ci= " & ci & " and idgrupo= " & idgrupo & " and idasig= " & idasig & " and anio = " & Now.Year & ""
                Cmd.CommandText = sql
                Cmd.ExecuteNonQuery()
                ...
                DGADocente.DataSource = Ds.Tables("dictan")
            Else
                sql = "UPDATE dictan set activo='Activo' where ci= " & ci & " and idgrupo= " & idgrupo & " and idasig= " & idasig & " and anio = " & Now.Year & ""
                Cmd.CommandText = sql
                Cmd.ExecuteNonQuery()
                MsgBox("Estado cambiado a Activo")
