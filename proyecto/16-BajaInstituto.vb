Public Class BajaInstituto
    ...
    Private Sub btnborrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnborrar.Click
        conn()
        Try
            idinst = cmbnomasig.Text
            sql = "SELECT activo from instituto where idinst = " & cmbnomasig.Text & ""
            Cmd.CommandText = sql
            Cmd.ExecuteScalar()
            ...
            If activo <> "" Then
                ...
                If activo = "Activo" Then
                    ...
                    Try
                        ...
                        sql = "INSERT INTO historia (ciautor,pk,accion,descripcion,tabla,fecha,hora) VALUES ( " & login2 & ",'" & idinst & "','Update','Estado cambiado a: No Activo','instituto', '" & fecha2 & "', '" & lblhora2.Text & "')"

                        Cmd.CommandText = sql

                        Cmd.ExecuteNonQuery()
                        conect.Close()
                        MsgBox("Instituto deshabilitado", MsgBoxStyle.Information, "Aviso")
                ...
                If activo = "No Activo" Then
                    ...
                    Try
                        ...
                        sql = "INSERT INTO historia (ciautor,pk,accion,descripcion,tabla,fecha,hora) VALUES ( " & login2 & ",'" & idinst & "','Update','Estado cambiado a: Activo','instituto', '" & fecha2 & "', '" & lblhora2.Text & "')"

                        Cmd.CommandText = sql

                        Cmd.ExecuteNonQuery()
                        conect.Close()
                        MsgBox("Instituto habilitado", MsgBoxStyle.Information, "Aviso")
                ...
                End If
            Else
                MsgBox("El instituto ingresado no existe", MsgBoxStyle.Information, "Aviso")
            End If
        Else
            MsgBox("No se puede dejar el campo en blanco")
        End If
        conect.Close()
    End Sub
    ...
    Private Sub cmbnominst_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub btnAsignatura_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAsignatura.Click
        ...
        sql = "SELECT nombre,activo from instituto"
        Cmd.CommandText = sql
    ...
    Private Sub txtBuscar_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtBuscar.KeyPress
        If e.KeyChar = Chr(13) Then
            ...
            Ds.Clear()
            DGVConsulta.Visible = True
            sql = "SELECT nombre,activo from instituto where nombre like '%" & txtBuscar.Text & "%'"
            Cmd.CommandText = sql
